...
const Header = () => {
  const [IseSearchActive, setIseSearchActive] = useState(false);
  return (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden sm:flex flex-1 max-w-xl mx-8">
            <div className="relative w-full group">
              <Search
                className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#FA8112] transition-colors"
                size={20}
              />
              <input
                onClick={() => setIseSearchActive(!IseSearchActive)}
                type="text"
